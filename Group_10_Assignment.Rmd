...
- The model that produced the has the highest predictability of prices per night includes the type of property, number of reviews, review scores rating, room type and neighborhood
- Despite that, the reliability of the model is not high, so further analysis is required to determine the best variables to predict the price per night in Istanbul
