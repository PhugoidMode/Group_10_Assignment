...
```{r}
model3 <- lm(price_4_nights ~ prop_type_simplified + number_of_reviews + review_scores_rating + instant_bookable + neighbourhood_cleansed, data = four_nights_for_two_listings)
...
unique(new_listings$neighbourhood_cleansed)
