...
head(four_nights_for_two_listings)
unique(four_nights_for_two_listings$prop_type_simplified)

updated_four_nights_for_two_listings <- four_nights_for_two_listings %>% 
  filter(prop_type_simplified == "Private room" & number_of_reviews >= 10 & review_scores_rating >= 4.5)
