...
ggplot(listings, aes(x= minimum_nights)) +
  ...
  theme_bw() +                
  labs (
    title = "Histogram for Minimum Nights to Stay",
    x= "Minimum Nights",
    y= "Number of Minimum Nights to Stay")

#Histogram for Maximum Nights 
ggplot(listings, aes(x= maximum_nights)) +
  geom_histogram(alpha=0.2) +   
  theme_bw() +                
  labs (
    title = "Histogram for Maximum Nights to Stay",
    x= "Maximum Nights",
    y= "Number of Maximum Nights to Stay")


#Bar chart for Property Type
ggplot(listings, aes(y= property_type )) +
  geom_bar(alpha=0.2) +   
  theme_bw() +                
  labs (
    title = "Property Type",
...
ggplot(listings, aes(y= room_type )) +
  geom_bar(alpha=0.2) +   
  theme_bw() +                
  labs (
    title = "Room Type")
...
ggplot(listings, aes(x= host_identity_verified  )) +
  geom_bar(alpha=0.2) +   
  theme_bw() +                
  labs (
...
ggplot(listings, aes(x= has_availability  )) +
  geom_bar(alpha=0.2) +   
  theme_bw() +                
  labs (
    title = "Availability Status",
    y= "Number of Properties Available",
...
Original data -> 23019 rows, 74 columns, 23 characters, 5 date, 9 logical variables, 37 numerical variables
Updated data (columns of interest are selected) -> 10824 rows, 25 columns, 2 logical variables, 23 numeric variables
...
#Change the type of Host Response Time to Numeric
listings$host_response_rate <- as.numeric(gsub('.{1}$', '', listings$host_response_rate))

#Histogram for Host Response Rate
ggplot(listings, aes(x= host_response_rate)) +
  geom_histogram(alpha=0.2) +   
  theme_bw() +                
  labs (
    title = "Histogram for Host Response Rate",
    x= "Host Response Rate",
    y= "Number of Responses")

#Change the type of Bathroom to Numeric
listings$bathrooms_text <- as.numeric(gsub('.{4}$', '', listings$bathrooms_text))
